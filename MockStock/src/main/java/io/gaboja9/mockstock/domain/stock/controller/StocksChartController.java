...
public class StocksChartController implements StocksChartControllerSpec {
  ...
  public StocksChartResponse<DailyStockPrice> loadPastDailyChartData(
    ...
    log.info("Loading past daily chart data for stock: {} before {}, limit: {}", stockCode,
  ...
  public StocksChartResponse<DailyStockPrice> loadRecentDailyChartData(
    ...
    log.info("Loading recent daily chart data for stock: {} after {}, limit: {}", stockCode,
  ...
  public StocksChartResponse<MinuteStockPrice> loadPastMinuteChartData(
    ...
    log.info("Loading past minute chart data for stock: {} before {}, limit: {}", stockCode,
        beforeTimestamp, limit);
  ...
  public StocksChartResponse<MinuteStockPrice> loadRecentMinuteChartData(
    ...
    log.info("Loading recent minute chart data for stock: {} after {}, limit: {}", stockCode,
        afterTimestamp, limit);
  ...
  public StocksChartResponse<DailyStockPrice> loadPastWeeklyChartData(
    ...
    log.info("Loading past weekly chart data for stock: {} before {}, limit: {}", stockCode,
        beforeTimestamp, limit);
  ...
  public StocksChartResponse<DailyStockPrice> loadRecentWeeklyChartData(
    ...
    log.info("Loading recent weekly chart data for stock: {} after {}, limit: {}", stockCode,
        afterTimestamp, limit);
