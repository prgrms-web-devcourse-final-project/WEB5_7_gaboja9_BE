...
public interface StocksChartControllerSpec {
                ...
                @ApiResponse(
                        ...
                        content =
                                @Content(
                                        ...
                                        schema =
                                                @Schema(implementation = StocksChartResponse.class),
                                        examples =
                                                @ExampleObject(
                                                        name = "성공 예시",
                                                        value =
    ...
    StocksChartResponse<DailyStockPrice> getInitialDailyChartData(
            @Parameter(description = "종목 코드", required = true) @PathVariable @NotBlank
                    String stockCode,
    ...
    StocksChartResponse<MinuteStockPrice> getInitialMinuteChartData(
            @Parameter(description = "종목 코드", required = true) @PathVariable @NotBlank
                    String stockCode,
            @Parameter(description = "조회할 데이터 개수", example = "200")
    ...
    StocksChartResponse<MinuteStockPrice> loadPastMinuteChartData(
            @Parameter(description = "종목 코드", required = true) @PathVariable @NotBlank
                    String stockCode,
            @Parameter(description = "기준 시점", required = true, example = "2025-07-29T12:30:00Z")
                    @RequestParam("before")
                    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
                    Instant beforeTimestamp,
            @Parameter(description = "조회할 데이터 개수", example = "100")
    ...
    StocksChartResponse<MinuteStockPrice> loadRecentMinuteChartData(
            @Parameter(description = "종목 코드", required = true) @PathVariable @NotBlank
                    String stockCode,
            @Parameter(description = "기준 시점", required = true, example = "2025-07-29T13:00:00Z")
                    @RequestParam("after")
                    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
                    Instant afterTimestamp,
            @Parameter(description = "조회할 데이터 개수", example = "50")
    ...
    StocksChartResponse<DailyStockPrice> getInitialWeeklyChartData(
            @Parameter(description = "종목 코드", required = true) @PathVariable @NotBlank
                    String stockCode,
            @Parameter(description = "조회할 데이터 개수 (52개 = 1년)", example = "52")
    ...
    StocksChartResponse<DailyStockPrice> loadPastWeeklyChartData(
            @Parameter(description = "종목 코드", required = true) @PathVariable @NotBlank
                    String stockCode,
            @Parameter(description = "기준 시점", required = true, example = "2024-07-29T00:00:00Z")
                    @RequestParam("before")
                    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
                    Instant beforeTimestamp,
            @Parameter(description = "조회할 데이터 개수 (26개 = 6개월)", example = "26")
    ...
    StocksChartResponse<DailyStockPrice> loadRecentWeeklyChartData(
            @Parameter(description = "종목 코드", required = true) @PathVariable @NotBlank
                    String stockCode,
            @Parameter(description = "기준 시점", required = true, example = "2025-07-28T00:00:00Z")
                    @RequestParam("after")
                    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
                    Instant afterTimestamp,
