...
public class StocksDataService {
    ...
    public void fetchAndSaveData(
        ...
        try {
            // 1. API 호출
            String responseBody =
                    callHantuApi(marketCode, stockCode, startDate, endDate, periodCode);
    ...
    public void fetchAndSaveLongTermData(
        ...
        log.info("장기간 {}봉 데이터 수집 시작: {}, 기간: {} ~ {}", periodCode, stockCode, startDate, endDate);
        ...
        log.info(
                "장기간 {}봉 데이터 수집 완료 - 종목: {}, 총 배치: {}개, 성공: {}개, 실패: {}개",
                periodCode,
                stockCode,
                batchCount,
                successCount,
