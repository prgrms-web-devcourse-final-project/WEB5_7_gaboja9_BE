...
public class StocksDailyRepository {
  ...
  public List<DailyStockPrice> findLatestDailyPrices(String stockCode, int limit) {
    ...
    log.debug("Retrieved {} latest daily price records for stock: {}", results.size(), stockCode);
    return results;
  }
   ...
   */
  public List<DailyStockPrice> findDailyPricesBefore(String stockCode, Instant beforeTimestamp,
      int limit) {
    String flux = String.format("""
        from(bucket: "%s")
          |> range(start: -3y)
    ...
    log.debug("Loading {} daily prices before {} for stock: {}", limit, beforeTimestamp, stockCode);
    ...
    log.debug("Retrieved {} daily price records before {} for stock: {}",
   ...
   */
  public List<DailyStockPrice> findDailyPricesAfter(String stockCode, Instant afterTimestamp,
      int limit) {
    String flux = String.format("""
        from(bucket: "%s")
    ...
    log.debug("Loading {} daily prices after {} for stock: {}", limit, afterTimestamp, stockCode);
    ...
    log.debug("Retrieved {} daily price records after {} for stock: {}",
