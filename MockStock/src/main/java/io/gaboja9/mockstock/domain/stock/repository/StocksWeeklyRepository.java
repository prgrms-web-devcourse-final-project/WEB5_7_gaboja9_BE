...
public class StocksWeeklyRepository {
  ...
  public List<DailyStockPrice> findStoredWeeklyPricesBefore(String stockCode,
  ...
  public List<DailyStockPrice> findStoredWeeklyPricesAfter(String stockCode, Instant afterTimestamp,
      int limit) {
    String flux = String.format(
        """
            from(bucket: "%s")
  ...
  public List<DailyStockPrice> aggregateFromDailyBefore(String stockCode, Instant beforeTimestamp,
      int limit) {
    String flux = String.format(
        """
            from(bucket: "%s")
  ...
  public List<DailyStockPrice> aggregateFromDailyAfter(String stockCode, Instant afterTimestamp,
      int limit) {
    String flux = String.format(
        """
            from(bucket: "%s")
