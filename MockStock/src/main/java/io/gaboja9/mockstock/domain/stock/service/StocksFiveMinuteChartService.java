...
public class StocksFiveMinuteChartService {
  ...
  public List<MinuteStockPrice> getMorePastData(String stockCode, Instant beforeTimestamp,
    ...
    return stocksFiveMinuteRepository.findFiveMinutePricesBefore(stockCode, beforeTimestamp, limit);
  }
  ...
  public List<MinuteStockPrice> getMoreRecentData(String stockCode, Instant afterTimestamp,
    ...
    return stocksFiveMinuteRepository.findFiveMinutePricesAfter(stockCode, afterTimestamp, limit);
  }
