...
public class DailyStockPrice {
  ...
  @Schema(
      description = "최고가 (해당 일의 가장 높은 거래 가격)",
      example = "62400",
      minimum = "0"
  )
  @Column
  ...
  @Schema(
      description = "최저가 (해당 일의 가장 낮은 거래 가격)",
      example = "61000",
      minimum = "0"
  )
  @Column
  ...
  @Schema(
      description = "누적 거래량 (해당 일의 총 거래된 주식 수)",
      example = "20213724",
      minimum = "0"
  )
  @Column
  ...
  @Schema(
      description = "종가 (해당 일의 마지막 거래 가격)",
      example = "61400",
      minimum = "0"
  )
  @Column
