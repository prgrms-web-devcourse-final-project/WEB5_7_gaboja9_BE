...
public class NotFoundStockException extends BaseException {
    public NotFoundStockException() { super(ErrorCode.NOT_FOUNT_STOCK);}

    public NotFoundStockException(String stockCode) {super(ErrorCode.NOT_FOUNT_STOCK, "주식을 찾을 수 없습니다. ID: " + stockCode);}
}
