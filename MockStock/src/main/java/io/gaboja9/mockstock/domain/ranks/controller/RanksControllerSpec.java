...
public interface RanksControllerSpec {
    ...
    ResponseEntity<RankingResponse> getRankingWithPagination(
            ...
            @Parameter(
                    ...
                    examples = {
                            @ExampleObject(name = "수익률 랭킹", value = "RETURN_RATE", description = "수익률 기준 랭킹"),
                            @ExampleObject(name = "수익금 랭킹", value = "PROFIT", description = "수익금 기준 랭킹"),
                            @ExampleObject(name = "자산 랭킹", value = "ASSET", description = "총 자산 기준 랭킹"),
                            @ExampleObject(name = "파산 횟수 랭킹", value = "BANKRUPTCY", description = "파산 횟수 기준 랭킹")
                    }
            )
            ...
            @Parameter(
                    ...
                    required = false,
                    in = ParameterIn.QUERY,
                    schema = @Schema(type = "integer", minimum = "1", maximum = "50", defaultValue = "5"),
                    examples = {
