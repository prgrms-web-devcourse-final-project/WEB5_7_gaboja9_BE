...
public class HantuWebSocketConnectionManager extends WebSocketConnectionManager {
  ...
  public HantuWebSocketConnectionManager(WebSocketClient client,
  ...
  private void startHeartbeat() {
    ...
    heartbeatTask = scheduler.scheduleAtFixedRate(() -> {
      ...
      if (this.running && (sessionManager.getSession() == null || !sessionManager.getSession().isOpen())) {
        log.warn("Heartbeat detected inactive session. Attempting to reconnect...");
        reconnect();
      }
