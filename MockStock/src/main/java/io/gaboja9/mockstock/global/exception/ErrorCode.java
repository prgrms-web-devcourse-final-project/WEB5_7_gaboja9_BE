...
public enum ErrorCode {
  ...
  INVALID_CHART_LIMIT(HttpStatus.BAD_REQUEST, "STOCK-CHART-002",
      "조회할 데이터 개수는 1개 이상 1000개 이하여야 합니다."),
  INVALID_TIMESTAMP_REQUIRED(HttpStatus.BAD_REQUEST, "STOCK-CHART-003", "기준 시점이 필요합니다."),
  STOCK_DATA_FETCH_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "STOCK-CHART-004",
      "주식 데이터 조회에 실패했습니다."),
  INFLUXDB_CONNECTION_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "STOCK-CHART-005",
      "데이터베이스 연결에 실패했습니다.");
