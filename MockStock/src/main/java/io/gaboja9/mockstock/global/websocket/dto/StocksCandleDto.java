...
public class StocksCandleDto {
   ...
   */
  public static StocksCandleDto createNew(String stockCode, long timestamp, int price,
      long volume) {
    return StocksCandleDto.builder()
        .stockCode(stockCode)
        .timestamp(timestamp)
  ...
  public String toString() {
    return String.format("[%s] %s | %s T:%d",
        stockCode, getInstant(), getOHLCVString(), tickCount);
  }
