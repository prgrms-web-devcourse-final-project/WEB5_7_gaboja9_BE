...
public class WebSocketConfig implements WebSocketConfigurer {
  ...
  public WebSocketClient webSocketClient() {
    ...
    client.getUserProperties().put("org.apache.tomcat.websocket.textBufferSize", 5 * 1024 * 1024);
    client.getUserProperties().put("org.apache.tomcat.websocket.binaryBufferSize", 5 * 1024 * 1024);
    // 타임아웃 설정 (60초)
  ...
  public HantuWebSocketConnectionManager HantuWebSocketConnectionManager(
    ...
    HantuWebSocketConnectionManager connectionManager = new HantuWebSocketConnectionManager(
        webSocketClient,
        handler,
        websocketUri,
